...
void tiang(void) {
	...
	glVertex3f(-14, -5, 5.5);
	glVertex3f(-10, -5, 5.5);
	glVertex3f(-10, -5, 25.5);
	glVertex3f(-14, -5, 25.5);
	glEnd();
	...
	glVertex3f(-14, 0, 5.5);
	glVertex3f(-10, 0, 5.5);
	glVertex3f(-10, 0, 28.5);
	glVertex3f(-14, 0, 28.5);
	glEnd();

	glBegin(GL_QUADS);//KIRI	
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-14, -5.0, 5.5);
	glVertex3f(-14, -0, 5.5);
	glVertex3f(-14, -0, 28.5);
	glVertex3f(-14, -5.0, 25.5);
	glEnd();
	...
	glVertex3f(-10, -0, 5.5);
	glVertex3f(-10, -0, 28.5);
	glVertex3f(-10, -5.0, 25.5);
	glEnd();

	glBegin(GL_POLYGON);//kebawah
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-14.0, -20.0, 26.5);
	glVertex3f(-14.0, 0.0, 28.5);
	glVertex3f(-10.0, 0.0, 28.5);
	glVertex3f(-10.0, -20.0, 26.5);
	glEnd();

	glBegin(GL_QUADS);//kebawah kanan
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-10, -20.0, 23.5);
	glVertex3f(-10, -0, 26.5);
	glVertex3f(-10, -0, 28.5);
	glVertex3f(-10, -20.0, 26.5);
	glEnd();

	glBegin(GL_QUADS);//kebawah kiri
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-14, -20.0, 23.5);
	glVertex3f(-14, -0, 26.5);
	glVertex3f(-14, -0, 28.5);
	glVertex3f(-14, -20.0, 26.5);
	glEnd();
	...
	glVertex3f(-20, -5, 5.5);
	glVertex3f(-24, -5, 5.5);
	glVertex3f(-24, -5, 25.5);
	glVertex3f(-20, -5, 25.5);
	glEnd();
	...
	glBegin(GL_QUADS);//KIRI	
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-20, -5.0, 5.5);
	glVertex3f(-20, -0, 5.5);
	glVertex3f(-20, -0, 28.5);
	glVertex3f(-20, -5.0, 25.5);
	glEnd();
	...
	glVertex3f(-24, -0, 5.5);
	glVertex3f(-24, -0, 28.5);
	glVertex3f(-24, -5.0, 25.5);
	glEnd();

	glBegin(GL_POLYGON);//kebawah
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-20.0, -20.0, 26.5);
	glVertex3f(-20.0, 0.0, 28.5);
	glVertex3f(-24.0, 0.0, 28.5);
	glVertex3f(-24.0, -20.0, 26.5);
	glEnd();

	glBegin(GL_QUADS);//kebawah kanan
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-24, -20.0, 23.5);
	glVertex3f(-24, -0, 26.5);
	glVertex3f(-24, -0, 28.5);
	glVertex3f(-24, -20.0, 26.5);
	glEnd();
	...
	glVertex3f(-30, -5, 5.5);
	glVertex3f(-34, -5, 5.5);
	glVertex3f(-34, -5, 25.5);
	glVertex3f(-30, -5, 25.5);
	glEnd();
	...
	glVertex3f(-30, 0, 5.5);
	glVertex3f(-34, 0, 5.5);
	glVertex3f(-34, 0, 28.5);
	glVertex3f(-30, 0, 28.5);
	glEnd();

	glBegin(GL_QUADS);//KIRI	
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-30, -5.0, 5.5);
	glVertex3f(-30, -0, 5.5);
	glVertex3f(-30, -0, 28.5);
	glVertex3f(-30, -5.0, 25.5);
	glEnd();

	glBegin(GL_QUADS);//kanan
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-34, -5.0, 5.5);
	glVertex3f(-34, -0, 5.5);
	glVertex3f(-34, -0, 28.5);
	glVertex3f(-34, -5.0, 25.5);
	glEnd();

	glBegin(GL_POLYGON);//kebawah
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-30.0, -20.0, 26.5);
	glVertex3f(-30.0, 0.0, 28.5);
	glVertex3f(-34.0, 0.0, 28.5);
	glVertex3f(-34.0, -20.0, 26.5);
	glEnd();

	glBegin(GL_QUADS);//kebawah kanan
	glColor3f(1.0, 0.5, 0.0);
	glVertex3f(-34, -20.0, 23.5);
	glVertex3f(-34, -0, 26.5);
	glVertex3f(-34, -0, 28.5);
	glVertex3f(-34, -20.0, 26.5);
	glEnd();
